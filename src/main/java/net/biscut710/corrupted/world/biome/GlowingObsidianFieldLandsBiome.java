...
public class GlowingObsidianFieldLandsBiome {
	public static Biome createBiome() {
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, PlacementUtils.register(
				...
				FeatureUtils.register("corrupted_mc:tree_glowing_obsidian_field_lands", Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(
						BlockStateProvider.simple(CorruptedMcModBlocks.GLOWING_OBSIDIAN.get().defaultBlockState()), new StraightTrunkPlacer(7, 2, 0),
