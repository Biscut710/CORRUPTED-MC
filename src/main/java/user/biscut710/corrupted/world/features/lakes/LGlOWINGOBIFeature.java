...
package user.biscut710.corrupted.world.features.lakes;
...
public class LGlOWINGOBIFeature extends LakeFeature {
	public static LGlOWINGOBIFeature FEATURE = null;
	public static Holder<ConfiguredFeature<LakeFeature.Configuration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new LGlOWINGOBIFeature();
