...
import user.biscut710.corrupted.item.PureNetheriteItem;
...
public class CorruptedMcModItems {
	...
	public static final RegistryObject<Item> PURE_NETHERITE = REGISTRY.register("pure_netherite", () -> new PureNetheriteItem());
